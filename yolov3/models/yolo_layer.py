...
class YOLOLayer(nn.Module):
    ...
    #             nB, -1, nC
    #         )
    #         output_ = torch.cat((pred_boxes * self.stride, x[..., 4:]), dim=-1)
    ...
    #     x[..., np.r_[:2, 4:nC]] = torch.logit(x[..., np.r_[:2, 4:nC]], eps=1e-6)
    ...
    #     loss_obj = F.binary_cross_entropy_with_logits(x[..., 4], target[..., 4], reduction="sum")
    #     loss_cls = F.binary_cross_entropy_with_logits(x[..., 5:], target[..., 5:], reduction="sum")
